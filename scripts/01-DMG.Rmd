...
Filtering to genes that have at least 6 CpG loci in the dataset with 5X coverage 
...
Testing filtering by CpG loci median methylation %. Commented out so the 9,467 genes are carried through to DMG analysis
...
Binomial GLM to test for differentially methylated genes. For 359 genes this took ~1 min. 
...
Binomial GLM to test for differentially methylated genes. For 7,413 genes this took ~10 minutes. 
...
methgroup: 3,870 genes significantly DMG out of 9,467 genes that had at least 5 positions and appeared in all samples.
