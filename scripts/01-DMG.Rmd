...
ggsave(filename="data/figures/Percent_methylation_all.jpeg", width=8, height=7, units="in")
...
ggsave(filename="data/figures/Percent_methylation_sigDMGs.jpeg", width=8, height=7, units="in")
...
ggsave(filename="data/figures/Percent_methylation_filtered.jpeg", width=6, height=3, units="in")
```
...
meth_table5x_filtered2 %>% write.csv("data/WGBS/meth_table5x_filtered2.csv", quote = FALSE, row.names = FALSE)
meth_table5x_filtered2_sigDMG %>% write.csv("data/WGBS/meth_table5x_filtered2_sigDMG.csv", quote = FALSE, row.names = FALSE)
```
